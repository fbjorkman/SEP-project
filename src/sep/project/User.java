...
public class User implements Runnable {
    ...
    GUISeniorHRManager seniorHRManager;
    ...
    public void run() {
        switch (name) {
            ...
            case "SeniorHRManager":
                seniorHRManager = new GUISeniorHRManager(notificationList);
                seniorHRManager.frame.setVisible(true);
                break;
        }
