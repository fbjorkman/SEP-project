...
//                    window1.frame.setVisible(true);
                    ...
                    EventRequestForm test2 = new EventRequestForm(2, "name2", "type2", "11/12", "12/10", 200, true, true, false, true, true, 10000);
                    EventRequestForm test3 = new EventRequestForm(3, "name3", "type3", "12/13", "13/10", 300, true, true, false, true, true, 10000);
                    testList.add(test1);
                    testList.add(test2);
                    testList.add(test3);
